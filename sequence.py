...
class Experiment:
    ...
    def run_epoch(self, epoch):
        ...
        #
        # # Predict
        images, labels = self.dataset.random_sample(n=1)
        ...
        # print("images:",images)
        # print("prediction_logprob:",prediction_logprob)
    ...
    def run(self):
        ...
        self.writer.export_scalars_to_json(self.config.EXPERIMENT_DIR+'/scalars.json')
...
if __name__ == "__main__":
    ...
    5. Run
    """
    experiment = Experiment(config=config.ConfigLSTM())
    experiment.run()